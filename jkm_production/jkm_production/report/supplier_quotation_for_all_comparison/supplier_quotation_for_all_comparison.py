...
def get_data(filters):
	...
	query = (
		...
		.where(
			...
			& (sq.custom_quotation_request_for == quotation_type)
	...
	if filters.get('place_of_delivery'):
		query = query.where(sq.custom_place_of_delivery == filters.get('place_of_delivery'))
	if filters.get('port_of_destination'):
		query = query.where(sq.custom_place_of_destination == filters.get('place_of_destination'))
	if filters.get('port_of_origin'):
		query = query.where(sq.custom_port_of_origin == filters.get('port_of_origin'))
